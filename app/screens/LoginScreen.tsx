...
export const LoginScreen = () => {
  ...
  const renderContent = () => (
    ...
    >
      <View style={{ flexDirection: "row", paddingTop: 20 }}>
        ...
        >
          <Text
            style={{ fontSize: 16, color: "#fff", fontFamily: "SBSansDisplay" }}
          >
            Вход
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text
            style={{ fontSize: 16, color: "#000", fontFamily: "SBSansDisplay" }}
          >
            Регистрация
          </Text>
        </TouchableOpacity>
      ...
      <View style={{ paddingHorizontal: 10 }}>
        <Text style={{ fontSize: 18, fontFamily: "SBSansDisplay" }}>
          Пароль
        </Text>
      ...
      <View
        style={{ width: "100%", flexDirection: "row-reverse", marginTop: 20 }}
      >
        <TouchableOpacity style={{}} onPress={() => alert("Hello, world!")}>
          <Text
            style={{
              fontSize: 18,
              color: "#07E897",
  ...
  const sheetRef = useRef<BottomSheetBehavior | null>(null);
